...
Two middleware functions are provided by default in the `waistgraph.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `waistgraph.handler` namespace to manage the enabled middleware.
